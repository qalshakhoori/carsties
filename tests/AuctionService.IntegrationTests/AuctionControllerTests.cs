...
public class AuctionControllerTests : IAsyncLifetime
{
  ...
  {
    // arrange
    var auction = GetAuctionForCeate();
  ...
  public Task InitializeAsync() => Task.CompletedTask; // going to activate before each test

  public Task DisposeAsync() // going to activate after each test
  {
  ...
  private CreateAuctionDto GetAuctionForCeate()
  {
